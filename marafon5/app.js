...
('#board')
const colors = ['red','blue','green','yellow','purple','olive','aqua','navy',
    'beige','chartreuse','darkorange','khaki','lightpink','olive','violet']
let time = 0
let score = 0
...
function createRandomCircle(){
    ...
    circle.style.left = `${x}px`
        ...
        circle.style.boxShadow = `  0 0 7px ${color},0 0 10px ${color}`
